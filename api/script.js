...
(function (Api) {
    function drawQrCode() {
        var _a, _b, _c;
        function makeSegments(binary, data) {
            if (binary) {
        ...
        function getVer(ver, minVer, maxVer) {
            const parsedVer = parseInt(ver !== null && ver !== void 0 ? ver : '');
            let parsedMinVer = parseInt(minVer !== null && minVer !== void 0 ? minVer : '');
            let parsedMaxVer = parseInt(maxVer !== null && maxVer !== void 0 ? maxVer : '');
            if (isNaN(parsedVer)) {
        ...
        function getMask(mask) {
            const parsedMask = parseInt(mask !== null && mask !== void 0 ? mask : '');
            if (isNaN(parsedMask)) {
                return -1;
            }
        ...
        function parseIntAndClamp(value, def, min, max) {
            const parsedValue = parseInt(value !== null && value !== void 0 ? value : '');
        ...
        function getColors(color, defColor) {
        ...
        function drawPng(qr, border, size, offColor, onColor, bgColor, text, textColor) {
            if (border < 0) {
        ...
        function drawImage(qr, border, size, offColor, onColor, bgColor, text, textColor, format) {
        ...
        const ecl = getEcl((_a = urlParams.get('ecl')) !== null && _a !== void 0 ? _a : 'M');
        ...
        const boostEcl = (_b = parseBool(urlParams.get('boost-ecl'))) !== null && _b !== void 0 ? _b : false;
        const qr = QrCodeGenerator.QrCode.encodeSegments(segs, ecl, minVer, maxVer, mask, boostEcl);
        ...
        const text = (_c = urlParams.get('text')) !== null && _c !== void 0 ? _c : '';
...
(function (QrCodeGenerator) {
    ...
    class QrCode {
        ...
        static encodeText(text, ecl) {
            const segs = QrCodeGenerator.QrSegment.makeSegments(text);
        ...
        static encodeBinary(data, ecl) {
            const seg = QrCodeGenerator.QrSegment.makeBytes(data);
    ...
    class QrSegment {
        ...
        static makeSegmentsFromBinary(binary) {
            if (binary == "")
                return [];
        ...
        static toByteArray(str) {
            ...
            matches === null || matches === void 0 ? void 0 : matches.forEach(element => {
    ...
    QrSegment.BINARIC_REGEX = /^([0-9A-Fa-f]{2}[ ,]*)*$/;
